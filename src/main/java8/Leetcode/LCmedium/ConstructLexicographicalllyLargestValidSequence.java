...
// LC-1718
public class ConstructLexicographicalllyLargestValidSequence {
        ...
        public static int[] constructDistancedSequence(int targetNumber) {
        ...
        private static boolean findLexicographicallyLargestSequence(
                int currentIndex,
                int[] resultSequence,
