...
public class KthLexicographicValidString {


        public static void main(String[] args){
            System.out.println('1' + 2);
            String[] result = new String[1];
            generateHappyStrings(3, 4, new StringBuilder(""), new int[1], result);

            System.out.println(result[0] == null ? "" : result[0]);
        }

        private static void generateHappyStrings(
                int n,
                int k,
